...
const STAR_STYLES: Record<string, { fill: string; border: string; glow: string; extraClass?: string }> = {
  ...
  rainbow: { fill: "", border: "", glow: "rgba(236, 72, 153, 0.7)", extraClass: "animate-rainbow-star" },
  emerald: { fill: "fill-emerald-300", border: "text-emerald-500", glow: "rgba(16, 185, 129, 0.6)" },
  ...
  cosmic_black: { fill: "fill-violet-950", border: "text-violet-800", glow: "rgba(139, 92, 246, 0.8)", extraClass: "brightness-75" },
  sakura_petals: { fill: "fill-rose-200", border: "text-rose-400", glow: "rgba(251, 113, 133, 0.5)" },
  ghostly: { fill: "fill-indigo-200", border: "text-indigo-400", glow: "rgba(129, 140, 248, 0.6)", extraClass: "opacity-80 animate-pulse" },
  toxic: { fill: "fill-lime-300", border: "text-lime-500", glow: "rgba(132, 204, 22, 0.6)" },
  lava: { fill: "fill-orange-400", border: "text-red-500", glow: "rgba(239, 68, 68, 0.7)", extraClass: "animate-pulse" },
  candy: { fill: "fill-fuchsia-200", border: "text-pink-400", glow: "rgba(232, 121, 249, 0.6)" },
  butterfly: { fill: "fill-pink-350", border: "text-amber-300", glow: "rgba(232, 121, 249, 0.7)", extraClass: "animate-pulse" },
};
