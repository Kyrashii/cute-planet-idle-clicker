      ...
      <div className="p-4 sm:p-5 flex-grow overflow-y-auto space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 font-bold">
          <div className="bg-cosmic-surface p-3 rounded-2xl border-2 border-cosmic-accent/20">
            <span className="text-[9px] text-cosmic-accent-muted font-mono uppercase font-black tracking-wider">Erhobenes Leben (Gesamt)</span>
            <p className="font-mono text-sm font-black text-cosmic-pink mt-1" title={Math.floor(totalLifeEarned).toLocaleString("de-DE")}>
              {formatCompactNumber(totalLifeEarned)} 💖
            </p>
          </div>
          <div className="bg-cosmic-surface p-3 rounded-2xl border-2 border-cosmic-accent/20">
            <span className="text-[9px] text-cosmic-accent-muted font-mono uppercase font-black tracking-wider">Händische Klicks</span>
            <p className="font-mono text-sm font-black text-cosmic-text mt-1" title={clicksCount.toLocaleString("de-DE")}>
              {formatCompactNumber(clicksCount)} 👆
            </p>
          </div>
          <div className="bg-cosmic-surface p-3 rounded-2xl border-2 border-cosmic-accent/20">
            <span className="text-[9px] text-cosmic-accent-muted font-mono uppercase font-black tracking-wider">Sterne Autoclick Power</span>
          ...
          <div className="bg-cosmic-surface p-3 rounded-2xl border-2 border-cosmic-accent/20">
            <span className="text-[9px] text-cosmic-accent-muted font-mono uppercase font-black tracking-wider">Spieldauer</span>
            <p className="font-mono text-sm font-black text-teal-300 mt-1">
              {formatTimePlayed(secondsPlayed)}
            </p>
          </div>
          <div className="bg-cosmic-surface p-3 rounded-2xl border-2 border-cosmic-accent/20">
            <span className="text-[9px] text-cosmic-accent-muted font-mono uppercase font-black tracking-wider">Kosmisches Prestige</span>
          ...
          <div className="bg-cosmic-surface p-3 rounded-2xl border-2 border-cosmic-accent/20 col-span-2">
            <span className="text-[9px] text-cosmic-accent-muted font-mono uppercase font-black tracking-wider">Prestige Produktions-Multiplikator</span>
        ...
        <div className="bg-cosmic-surface-mid/50 border-2 border-cosmic-accent/40 rounded-2.5xl p-4 space-y-3">
          ...
          <div className="space-y-2.5 text-xs font-semibold text-cosmic-text">
            <div className="flex items-center justify-between border-b border-cosmic-accent/10 pb-2">
              ...
              <span className={Object.keys(purchasedAnimals).length > 0 ? "text-cosmic-pink font-black animate-pulse" : "text-gray-500 line-through font-mono text-[10px]"}>
            ...
            <div className="flex items-center justify-between border-b border-cosmic-accent/10 pb-2">
              ...
              <span className={starsCount >= 5 ? "text-cosmic-pink font-black animate-pulse" : "text-gray-500 line-through font-mono text-[10px]"}>
            ...
            <div className="flex items-center justify-between border-b border-cosmic-accent/10 pb-2">
              ...
              <span className={planetLevel >= 4 ? "text-cosmic-pink font-black animate-pulse" : "text-gray-500 line-through font-mono text-[10px]"}>
            ...
            <div className="flex items-center justify-between pb-1">
              ...
              <span className={totalLifeEarned >= 1000000 ? "text-cosmic-pink font-black animate-pulse" : "text-gray-500 line-through font-mono text-[10px]"}>
