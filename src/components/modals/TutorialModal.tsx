...
export const TutorialModal: React.FC<TutorialModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0a071c]/75 backdrop-blur-xl">
      <motion.div
      ...
      >
        ...
        <div>
          <span className={`text-[9px] font-mono font-black uppercase tracking-widest block mb-1.5 ${
            isNight ? "text-amber-350" : "text-amber-700 font-extrabold"
          }`}>
            SYSTEM START & EINFÜHRUNG
          </span>
          <h5 className={`font-sans font-black text-sm uppercase tracking-wide leading-tight ${
          ...
          <p className={`font-sans text-[11px] sm:text-xs mt-3.5 leading-relaxed font-semibold ${
            ...
            <br /><br />
            Kaufe niedliche, flauschige <b>Tiere</b>, die passiv Leben brüten, 
            und hole leuchtende <b>Sterne</b>, die den Planeten umkreisen und jede Sekunde automatisch für dich klicken! 
            <br /><br />
            Erforsche neue Upgrades wie den <b>Kosmischen Funken</b>, um deine Effizienz und deinen evolutionären EXP-Ertrag ins Unendliche zu steigern!
          </p>
        </div>
