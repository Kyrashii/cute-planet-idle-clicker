  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-950/60 backdrop-blur-sm animate-fade-in">
      <motion.div
        ...
        className={`modal-frame-target flex flex-col max-w-md w-full max-h-[85vh] shadow-2xl rounded-3xl overflow-hidden border-3 transition-colors duration-500 text-cosmic-text ${
          isNight ? "bg-[#181435]/95 border-cosmic-accent/70" : "bg-amber-50/95 border-amber-400 text-slate-800"
        }`}
      >
        {/* Modal Header */}
                    ...
                    <div className="flex-grow">
                      <div className="flex items-center justify-between">
                        <span className={`font-sans font-black text-xs uppercase tracking-wide leading-none ${
                          isActive
                            ? isNight ? "text-cosmic-text" : "text-amber-955"
                      ...
                      <p className={`text-[10px] font-semibold mt-1 leading-normal ${
                        isActive
                          ? isNight ? "text-cosmic-accent" : "text-amber-900"
        ...
        <div className={`p-4 text-[10px] text-center font-mono font-semibold opacity-75 leading-relaxed shrink-0 border-t transition-colors duration-500 ${
          isNight ? "bg-[#0c0920] border-cosmic-accent/25 text-cosmic-accent-muted" : "bg-amber-100/60 border-amber-200 text-amber-900"
        }`}>
