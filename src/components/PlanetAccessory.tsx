      ...
      return (
        <g id="accessory-flower-crown" className="pointer-events-none" transform="translate(0, 2)">
          ...
          <g transform="translate(68, 20) scale(0.65)">
            <circle cx="0" cy="-5" r="4" fill="#f472b6" /><circle cx="0" cy="5" r="4" fill="#f472b6" />
            <circle cx="-5" cy="0" r="4" fill="#f472b6" /><circle cx="5" cy="0" r="4" fill="#f472b6" />
            <circle cx="0" cy="0" r="2.5" fill="var(--color-cosmic-yellow)" />
          </g>
          <g transform="translate(86, 17) scale(0.75)">
            <circle cx="0" cy="-5" r="4" fill="#fff" /><circle cx="0" cy="5" r="4" fill="#fff" />
            <circle cx="-5" cy="0" r="4" fill="#fff" /><circle cx="5" cy="0" r="4" fill="#fff" />
            <circle cx="0" cy="0" r="2.5" fill="var(--color-cosmic-yellow)" />
          </g>
          <g transform="translate(100, 16) scale(0.85)">
            <circle cx="0" cy="-5" r="4" fill="#c084fc" /><circle cx="0" cy="5" r="4" fill="#c084fc" />
            <circle cx="-5" cy="0" r="4" fill="#c084fc" /><circle cx="5" cy="0" r="4" fill="#c084fc" />
    ...
    case "frog_hat":
      return (
        <g id="accessory-frog-hat" className="pointer-events-none" transform="translate(0, 1)">
          ...
          <circle cx="82" cy="7" r="6" fill="#fff" /><circle cx="80" cy="8" r="3.5" fill="#000" />
          <circle cx="118" cy="7" r="10" fill="#4ade80" stroke="var(--color-cosmic-border)" strokeWidth="2.5" />
          <circle cx="118" cy="7" r="6" fill="#fff" /><circle cx="120" cy="8" r="3.5" fill="#000" />
      ...
      return (
        <g id="accessory-pirate-hat" className="pointer-events-none" transform="translate(0, -2)">
          ...
          <g transform="translate(100, 7) scale(0.55)">
            ...
            <circle cx="-2.5" cy="-2" r="1.5" fill="#000" /><circle cx="2.5" cy="-2" r="1.5" fill="#000" />
    ...
    case "butterfly_wings":
      return (
        <g id="accessory-butterfly-wings" className="pointer-events-none">
          ...
          <circle cx="86" cy="-4" r="2" fill="#d946ef" /><circle cx="114" cy="-4" r="2" fill="#d946ef" />
