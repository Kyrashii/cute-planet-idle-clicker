...
export const CosmicFooter: React.FC = () => {
  return (
    <footer className="hidden game:block border-t-4 py-5 px-4 text-center text-[11px] mt-10 transition-colors duration-500 bg-cosmic-bg/95 border-cosmic-accent/50 text-cosmic-accent-muted">
